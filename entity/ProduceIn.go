...
type ProduceIn struct {
	...
	PlanProductCount string    `json:"plan_product_count" gorm:"plan_product_count"` // 计划产品数量
	...
	MaterielType     int64     `json:"materiel_type" gorm:"materiel_type"`           // 物料类型，1：原材料，2：半成品，3：成品
	ProductOutCode   string    `json:"product_out_code" gorm:"product_out_code"`     // 产品产出编码
	MaterielOutCode  string    `json:"materiel_out_code" gorm:"materiel_out_code"`   // 物料产出编码
	MaterielOutName  string    `json:"materiel_out_name" gorm:"materiel_out_name"`   // 物料产出名称
	MaterielOutType  int64     `json:"materiel_out_type" gorm:"materiel_out_type"`   // 物料产出类型，1：原材料，2：半成品，3：成品
